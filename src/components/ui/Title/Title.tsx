...
import titleBg from "@/assets/Homepage/bg-image.jpg";
...
const Title = ({ title, route, description }: TitleProps) => {
  return (
    <div className="bg-[url('/bg-image.jpg')] bg-cover bg-center h-[400px] bg-purple-800 relative overflow-hidden">
      <div className="w-full h-full bg-purple-950 bg-opacity-80 flex items-center">
